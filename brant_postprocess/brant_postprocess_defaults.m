...
switch(lower(process_str))
    case 'pre-process new' % for illustration purpose only
        process_pars.slicetiming = 1;
        process_pars.realign = 1;
        process_pars.normalise = 1;
        process_pars.smooth = 1;
        process_pars.out_dir = '';
        
        ui_structs = {...
            {'chb', 'num_bin'},      'slice timing',       {'slicetiming'},              '';...
            {'chb', 'num_bin'},      'realign',       {'realign'},              '';...
            {'chb', 'num_bin'},      'normalise',       {'normalise'},              '';...
            {'chb', 'num_bin'},      'smooth',       {'smooth'},              '';...
            {'sub_gui', 'disp_dirs_nii_nomask'},      'input_nifti',       '',              '';...
            {'edit', 'str_dir'},     'out dir',     {'out_dir'},      '';...
            };
        
        process_fun = @pre_process_new;
    ...
    case 'dicom convert'
        ...
        ui_structs = {...
            ...
            {'sub_gui', 'disp_dirs_only'},      'input_dcm',       '',              '';...
    ...
    case 'merge/extract rois'
        ...
        ui_structs = {...
            ...
            {'sub_gui', 'disp_3d_nifti_nomask'},      'input_nifti',       '',              '';...
...
%             {'edit', 'str_nifti'},       'roi file',   {'rois'},                 '';...
%             {'edit', 'str_edge'},       'roi info',    {'roi_info'},              '';...
%             {'sub_gui', 'disp_3d_nifti_mask'},      'input_nifti',       '',              '';...
...
%             };
%         
%         process_fun = @brant_extract_mean_3d_old;
    ...
    case 'fgn'
        ...
        ui_structs = {...
            {'sub_gui', 'disp_dirs_nii_mask'},      'input_nifti',       {{'filetype', 's*.nii'}, {'nm_pos', 0}},              '';...
            {'edit', 'num_short_right'},      'check timepoint',          {'timepoint'},              '';...
            {'chb', 'num_bin'},          'normalise transform',   {'nor'},                          '';...
            {'edit', 'str_dir'},     'out dir',     {'out_dir'},      ''
            };
    ...
    ui_structs = {...
        ...
        {'sub_gui', 'disp_2d_txt'},      'input_matrix',       {{'filetype', '*corr_z.txt'}},              '';...
        {'sub_gui', 'disp_3d_nifti_mask'},      'input_nifti',       '',              '';...
...
%         process_pars.smooth = 1;
    ...
    case 'roi mapping'
        ...
        process_pars.surface = {fullfile(brant_path, 'brant_surface', 'standard_withCC.txt')};
        process_pars.rois = {fullfile(brant_path, 'template', 'BN_Atlas_274_with_cerebellum_without_255.nii')};
        process_pars.roi_vec = [23,30,31,32];
        process_pars.roi_info = {fullfile(brant_path, 'template', 'roi_areas_274.txt')};
...
%             {'radio', 'vert_two'}, {'random color', 'input color'},               {'rand_color', 'input_color'},                          '';...
    ...
    case 'roi coordinates'
        ...
        ui_structs = {;...
            ...
            {'edit', 'str_nifti'},       'template',         {'template_img'},             '';...
            {'edit', 'str_edge'},      'info',    {'template_info'},              '';...
            {'edit', 'str_dir'},     'out dir',     {'out_dir'},      ''};
        
        process_fun = @brant_mask2table;
