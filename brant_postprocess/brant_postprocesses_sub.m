...
switch(lw_uiname)
    ...
    case 'statistics'
        ...
        if val_mat == 1
            ...
            obj_strs{2} = {'mat_vox2vox', 'input_matrix'}; % self
        else
            obj_strs{1} = {'mat_vox2vox', 'input_matrix'}; % dual
...
switch(ui_types{1})
    ...
    case {'edit'}
        switch(ui_types{2})
            case {'num_short_right', 'str_filetype_nifti', 'str_filetype_matrix', 'str_filetype_txt', 'num_coords', 'str_short_right'}
                sub_eles = {'text', 'edit'};
                pos_shift = [   0,                  0, text_size + [text_size(1), 0];...
                                disp_size(1) - numeric_size(1) - 25, 0, numeric_size];
