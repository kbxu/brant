function out = brant_spm_run_normalise_estwrite(outdir, varargin)
...
for i=1:numel(job.subj),
    ...
    out(i).params  = {fullfile(destdir,[nam,'_sn.mat'])};
    ...
    for j=1:numel(job.subj(i).resample),
        ...
        out(i).files{j}   = fullfile(destdir,[job.roptions.prefix, nam, ext, num]);
    end;
end;
return;
