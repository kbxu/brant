function varargout = brant_view(varargin)
% brant_view M-file for brant_view.fig
%      brant_view, by itself, creates a new brant_view or raises the existing
%      singleton*.
%
%      H = brant_view returns the handle to a new brant_view or the handle to
%      the existing singleton*.
%
%      brant_view('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in brant_view.M with the given input arguments.
%
%      brant_view('Property','Value',...) creates a new brant_view or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the brant_view before brant_view_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to brant_view_OpeningFcn via varargin.
%
%      *See brant_view Options on GUIDE's Tools menu.  Choose "brant_view allows only one
%      instance to run (singleton)".
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help brant_view

% Last Modified by GUIDE v2.5 09-Oct-2013 11:02:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @brant_view_OpeningFcn, ...
                   'gui_OutputFcn',  @brant_view_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before brant_view is made visible.
function brant_view_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to brant_view (see VARARGIN)
...
%==========================================================================
% Choose default command line output for brant_view
...
% UIWAIT makes brant_view wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = brant_view_OutputFcn(hObject, eventdata, handles) 
...
% loads the volume 
[handles.volume_coor, handles.volume_matrix, handles.trans_matrix, handles.volume_name, handles.value_range, sts] = loadVolume();
